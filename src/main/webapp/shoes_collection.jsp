    ...
    <section id="home" class="video-section js-height-full" style="background-color: #2c2f33">
        ...
        <div class="home-text-wrapper relative container" >
            <div class="home-message"  >
                ...
                <section class="section gb main-c " id="s-main"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px">Sports Shoes Collection</h1>
                ...
                <section class="section gb main-c " id="training"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px"> Training Shoes</h1>
                ...
                <section class="section gb main-c " id="soccer"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px">Soccer Shoes Collection</h1>
                ...
                <section class="section gb main-c " id="basket"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px">Basketball Shoes Collection</h1>
                ...
                <section class="section gb main-c " id="spikes"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px">Track and Field Spikes Collection</h1>
                ...
                <section class="section gb main-c " id="cricket"  style="padding: 0px;backface-visibility: hidden;overflow-x: hidden; background: unset" >
                    <h1 style="color: white;text-align: start;margin-left: 20px;
                    margin-top: 200px">Cricket Shoes Collection</h1>
